...
void OrbitCamera::processMouseInput(GLFWwindow* window) {
...
glm::mat4 OrbitCamera::getViewMatrix() { return glm::lookAt(position_, target_, up_); }

glm::mat4 OrbitCamera::getProjectionMatrix(float aspectRatio) {
